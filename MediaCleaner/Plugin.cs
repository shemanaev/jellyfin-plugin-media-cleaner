    ...
    public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages
    {
        ...
        public IEnumerable<PluginPageInfo> GetPages()
        {
            return new[]
            {
                ...
                new PluginPageInfo
                {
                    Name = "MediaCleaner_Integrations",
                    EmbeddedResourcePath = $"{GetType().Namespace}.Web.integrations.html"
                },
                new PluginPageInfo
                {
                    Name = "MediaCleaner_Integrations_js",
                    EmbeddedResourcePath = $"{GetType().Namespace}.Web.integrations.js"
                },
                new PluginPageInfo
                {
                    Name = "MediaCleaner_LeavingSoon",
                    EmbeddedResourcePath = $"{GetType().Namespace}.Web.leavingsoon.html"
                },
                new PluginPageInfo
                {
                    Name = "MediaCleaner_LeavingSoon_js",
                    EmbeddedResourcePath = $"{GetType().Namespace}.Web.leavingsoon.js"
                },
                new PluginPageInfo
                {
